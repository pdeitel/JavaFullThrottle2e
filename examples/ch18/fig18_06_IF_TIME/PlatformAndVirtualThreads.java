...
public class PlatformAndVirtualThreads {
   ...
   private static void executeAndTimeThreads(int tasks, 
      ...
      var durationMillis = Duration.between(start, end).toMillis();
      var seconds = durationMillis / 1000.0;
      var throughput = tasks / seconds; // tasks completed per second

      // display results
      System.out.printf("Execution time: %.2f seconds%n", seconds);
